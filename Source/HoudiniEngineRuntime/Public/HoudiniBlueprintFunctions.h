...
class HOUDINIENGINERUNTIME_API UHoudiniBlueprintFunctions : public UBlueprintFunctionLibrary
{
    ...
    UFUNCTION(BlueprintCallable, Category="Houdini FDM nozzle")
	static bool GetHAssetToggle(AHoudiniAssetActor* HoudiniAssetActor) { return GetHBool(HoudiniAssetActor, "extrude"); }
    UFUNCTION(BlueprintCallable, Category="Houdini FDM nozzle")
    ...
    UFUNCTION(BlueprintCallable, Category="Houdini FDM nozzle")
    static void GetHAssetPos(AHoudiniAssetActor* HoudiniAssetActor, FVector& ret) { return GetHVector(HoudiniAssetActor, "extr_pos", ret); }
    UFUNCTION(BlueprintCallable, Category="Houdini FDM nozzle")
    static void GetHAssetRot(AHoudiniAssetActor* HoudiniAssetActor, FQuat& ret) { return GetHQuat(HoudiniAssetActor, "extr_rot", ret); }
    UFUNCTION(BlueprintCallable, Category="Houdini FDM nozzle")
    ...
    UFUNCTION(BlueprintCallable, Category="Houdini FDM nozzle")
	static void HAssetSetPos(AHoudiniAssetActor* HoudiniAssetActor, const FVector& pos) { SetHVector(HoudiniAssetActor, "extr_pos", pos); }
	UFUNCTION(BlueprintCallable, Category="Houdini FDM nozzle")
	static void HAssetSetRot(AHoudiniAssetActor* HoudiniAssetActor, const FQuat& quat) { SetHQuat(HoudiniAssetActor, "extr_rot", quat); }
    UFUNCTION(BlueprintCallable, Category="Houdini FDM nozzle")
